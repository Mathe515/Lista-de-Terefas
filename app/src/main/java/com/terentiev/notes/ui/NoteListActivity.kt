...
class NoteListActivity : AppCompatActivity(), NoteListAdapter.TodoEvents {
    ...
    private lateinit var searchView: SearchView // adaptador de listagem de anotações(controla tudo da listagem)
    private lateinit var noteAdapter: NoteListAdapter // barra de pesquisa
